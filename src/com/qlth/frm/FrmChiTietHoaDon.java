...
DefaultTableModel tableModel = new DefaultTableModel();
     ...
     */
    public FrmChiTietHoaDon(Integer maHoaDon) {
        initComponents();
        loadDuLieuLenLuoi(maHoaDon);
    ...
    private void loadDuLieuLenLuoi(Integer maHoaDon) {
        ...
        List<NhatKyBanSach> nhatKyBanSachList = nhatKyBanSachDAO.getNhatKyBanSachById(maHoaDon);
